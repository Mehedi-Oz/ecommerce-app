            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-blog">
                        ...
                        <div class="blog-content">
                            <a class="category" href="javascript:void(0)">{{ __('eCommerce') }}</a>
                            <h4>
                                <a
                                    href="blog-single-sidebar.html">{{ __('What information is needed for shipping?') }}</a>
                            </h4>
                            <p>{{ __('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.') }}
                            </p>
                            <div class="button">
                                <a href="javascript:void(0)" class="btn">{{ __('Read More') }}</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-blog">
                        ...
                        <div class="blog-content">
                            <a class="category" href="javascript:void(0)">{{ __('Gaming') }}</a>
                            <h4>
                                <a href="blog-single-sidebar.html">{{ __('Interesting fact about gaming consoles') }}</a>
                            </h4>
                            <p>{{ __('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.') }}
                            </p>
                            <div class="button">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-blog">
                        ...
                        <div class="blog-content">
                            <a class="category" href="javascript:void(0)">{{ __('Electronic') }}</a>
                            <h4>
                                <a href="blog-single-sidebar.html">{{ __('Electronics, instrumentation & control engineering') }}
                                </a>
                            </h4>
                            <p>{{ __('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.') }}
                            </p>
