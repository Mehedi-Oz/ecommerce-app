                    ...
                    <div class="product-sidebar">
                        ...
                        <div class="single-widget">
                            ...
                            <ul class="list">
                                ...
                                <li>
                                    <a href="{{ route('product-category') }}">TV, Video & Audio</a><span>(420)</span>
                                </li>
                                <li>
                                    <a href="{{ route('product-category') }}">Cameras, Photo & Video</a><span>(874)</span>
                                </li>
                                <li>
                                    <a href="{{ route('product-category') }}">Headphones</a><span>(1239)</span>
                                </li>
                                <li>
                                    <a href="{{ route('product-category') }}">Wearable Electronics</a><span>(340)</span>
                                </li>
                                <li>
                                    <a href="{{ route('product-category') }}">Printers & Ink</a><span>(512)</span>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h4 class="title">
                                                    <a href="{{ route('product-details') }}">Bluetooth Speaker</a>
                                                </h4>
                                                <ul class="review">
                                                    <li><i class="lni lni-star-filled"></i></li>
                                                    <li><i class="lni lni-star-filled"></i></li>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h4 class="title">
                                                    <a href="{{ route('product-details') }}">iphone 6x plus</a>
                                                </h4>
                                                <ul class="review">
                                                    <li><i class="lni lni-star-filled"></i></li>
                                                    <li><i class="lni lni-star-filled"></i></li>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h4 class="title">
                                                    <a href="{{ route('product-details') }}">Wireless Headphones</a>
                                                </h4>
                                                <ul class="review">
                                                    <li><i class="lni lni-star-filled"></i></li>
                                                    <li><i class="lni lni-star-filled"></i></li>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                <span class="category">Speaker</span>
                                                <h4 class="title">
                                                    <a href="{{ route('product-details') }}">Mini Bluetooth Speaker</a>
                                                </h4>
                                                <ul class="review">
                                                    <li><i class="lni lni-star-filled"></i></li>
                                                    <li><i class="lni lni-star-filled"></i></li>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h4 class="title">
                                                    <a href="{{ route('product-details') }}">Apple MacBook Air</a>
                                                </h4>
                                                <ul class="review">
                                                    <li><i class="lni lni-star-filled"></i></li>
                                                    <li><i class="lni lni-star-filled"></i></li>
